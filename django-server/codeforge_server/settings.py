"""
Django settings for codeforge_server project.
...
SECRET_KEY = 'django-insecure-s(-tqs(x4y7z^nipu5&4q#+wu_42u+wz^dyw%d7!9&r3)7*96+'
...
ROOT_URLCONF = 'codeforge_server.urls'
